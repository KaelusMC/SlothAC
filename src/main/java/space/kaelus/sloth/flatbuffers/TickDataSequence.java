...
public final class TickDataSequence extends Table {
  ...
  public space.kaelus.sloth.flatbuffers.TickData ticks(int j) {
    return ticks(new space.kaelus.sloth.flatbuffers.TickData(), j);
  }

  public space.kaelus.sloth.flatbuffers.TickData ticks(
      space.kaelus.sloth.flatbuffers.TickData obj, int j) {
    int o = __offset(4);
  ...
  public space.kaelus.sloth.flatbuffers.TickData.Vector ticksVector() {
    return ticksVector(new space.kaelus.sloth.flatbuffers.TickData.Vector());
  }

  public space.kaelus.sloth.flatbuffers.TickData.Vector ticksVector(
      space.kaelus.sloth.flatbuffers.TickData.Vector obj) {
    int o = __offset(4);
